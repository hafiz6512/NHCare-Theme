...
//receive file from wordpress media
    ...
    function casestudy_textcontent() {
        ...
        $('.meta-box-sortables1').append('<div class="frm_field img-upload-box casStudiesBox postbox" ><div class="container hndle"><div class="close1 dashicons dashicons-minus" id="casestudySection"></div><input type="hidden" value="casestudy_textcontent" name="casestudiesdata[]"> <p><select name="casestudiesdata[]"><option value="show">Show</option> <option value="hide">Hide</option> </select></p><p><input class="tt txt'+inputnum+'" type="text" id="t'+inputnum+'" placeholder="Title" name="casestudiesdata[]" /></p>'+fld1+'</div></div>');
        $('.frm_i .field11').val(inputnum);
    ...
    function casstudiesvideo() {
        ...
        if($('.frm_i .chk_fld').val()==1)
        {
            ...
            fld1='<p><textarea name="casestudiesdata[]" class="area1" value="" placeholder="Video Content" /></textarea></p>';
        }
        $('.meta-box-sortables1').append('<div class="frm_field img-upload-box casStudiesBox postbox" ><div class="container hndle" style="padding-bottom:50px;"><div class="close1 dashicons dashicons-minus" id="casestudySection"></div><input type="hidden" value="casstudiesvideo" name="casestudiesdata[]">'+fld1+'</div></div>');
        $('.frm_i .field11').val(inputnum);
