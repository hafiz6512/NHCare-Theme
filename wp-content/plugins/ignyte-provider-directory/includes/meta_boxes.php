...
function ignyte_provider_directory_location_contents() {
	...
	<?php
		...
		foreach($locations as $loc){
			$getLocationsPostName = ucwords(str_replace('-', ' ', $loc->post_name));
...
function ignyte_provider_box_contents() {
	...
	?>
    <div class="input-group">
    <label for="ignyte-provider-displayed-name" ><?php _e( 'Provider Name', 'ignyte' )?></label>
        <br/>
    ...
    <br/>
    <div class="input-group">
        <label for="ignyte-provider-displayed-name" ><?php _e( 'First Name', 'ignyte' )?></label>
        <br/>
        <input style="width: 70%" type="text" name="ignyte-provider-fname" id="ignyte-provider-fname" value="<?php if ( isset ( $custom_fields['ignyte-provider-fname'] ) ) echo $custom_fields['ignyte-provider-fname'][0]; ?>" />
    </div>
    <br/>
    <div class="input-group">
        <label for="ignyte-provider-displayed-name" ><?php _e( 'Last Name', 'ignyte' )?></label>
        <br/>
        <input style="width: 70%" type="text" name="ignyte-provider-lname" id="ignyte-provider-lname" value="<?php if ( isset ( $custom_fields['ignyte-provider-lname'] ) ) echo $custom_fields['ignyte-provider-lname'][0]; ?>" />
    </div>
    <br/>
    <div class="input-group">
        <label for="ignyte-provider-displayed-name" ><?php _e( 'Designation/Position', 'ignyte' )?></label>
        <br/>
        <input style="width: 80%" type="text" name="ignyte-provider-position" id="ignyte-provider-position" value="<?php if ( isset ( $custom_fields['ignyte-provider-position'] ) ) echo $custom_fields['ignyte-provider-position'][0]; ?>" />
    </div>

    <br/>
    <div class="input-group">
    <label for="ignyte-provider-title" ><?php _e( 'Education', 'ignyte' )?></label><br/>
	<input  style="width: 90%" type="text" name="ignyte-provider-education" id="ignyte-provider-education" value="<?php if ( isset ( $custom_fields['ignyte-provider-education'] ) ) echo $custom_fields['ignyte-provider-education'][0]; ?>" />
     </div><br/>
    <div class="input-group">
    <label for="ignyte-provider-primary-service" ><?php _e( 'Practicing Since', 'ignyte' )?></label> <br/>
    ...
    */?>
    <label for="meta-checkbox">
        <input type="checkbox" name="show_service" id="show_service" value="yes" <?php if ( isset ( $custom_fields['show_service'] ) ) checked( $custom_fields['show_service'][0], 'yes' ); ?> />
        <?php _e( 'Show on Service Page', 'sm-textdomain' )?>
    </label>
    <br/>
	<div class="input-group">
...
function ignyte_provider_option_save_post_data($post_id){
  ...
  $post_meta_array=array("ignyte-provider-displayed-name","ignyte-provider-fname","ignyte-provider-lname","ignyte-provider-position","ignyte-provider-education","ignyte-provider-since","ignyte-provider-meta-image","show_service" );
