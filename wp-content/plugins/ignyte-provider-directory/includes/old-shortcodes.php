...
function ignyte_provider_search_form_shortcode($atts)
{
    ...
    <div class="row doctor-search-controls">
        ...
        <span><?php echo pll__("Search Provider Name");?></span>

        <div class="input-icon"><input type="text" placeholder="<?php echo pll__('Type here ...');?>" class="quicksearch" value=""></div>
        <span class=""><?php echo pll__("Filter Results");?></span>


        <div class="dropdown filters">
            <?php  $label = pll__('Locations'); ?>
            <button class="btn dropdown-toggle btn-blue form-control" type="button" id="doctor-location"
                    data-toggle="dropdown"><span><?=$label ?></span>
            </button>
            <ul class="dropdown-menu   button-group" role="menu" aria-labelledby="doctor-location"
                data-filter-group='doctor-location'>
                <?php
                $specialties = query_posts(array('post_type' => 'ignyte_locations','lang' => $lslug, 'posts_per_page' => '-1',
                ...
                <li class="team_filter_li is-checked" data-filter=""><a role="menuitem" tabindex="-1"
                                                                        ...
                                                                        href="javascript:void(0);"><?php  echo pll__('Any Location');?></a>
                </li>
                <?php foreach ($specialties as $spec) {
                    $removespace = preg_replace('/\s+/', '', $spec->post_title);
                    $listclass = $removespace . '-location';
                    ?>
                    <li role="presentation" class="team_filter_li" data-filter=".<?= $listclass ?>"><a  class="<?= $listclass ?>f" role="menuitem"
                                                                                                                          tabindex="-1"
    ...
    <ul class="dropdown-menu button-group" role="menu" aria-labelledby="specility-dropdown"
        ...
        ?>
        <li role="presentation" class="team_filter_li" data-filter=".<?php echo $listclass; ?>"><a role="menuitem" tabindex="-1"
                                                                                                   onclick="updatelabel('<?=$label;?>','<?= $wcatTerm2->name; ?>','specility-dropdown')"
                                                                                                   href="javascript:void(0);"><?php echo $wcatTerm2->name; ?></a>
        </li>
        <?php    } ?>
    </ul>
...
*/ ?>
        ...
        <div class="dropdown filters">
            ...
            <button class="btn dropdown-toggle btn-blue form-control" type="button" id="gender-dropdown"
                    data-toggle="dropdown"><span><?=$label ?></span></button>
            <ul class="dropdown-menu button-group" role="menu" aria-labelledby="gender-dropdown"
                data-filter-group='all_male'>
                <li role="presentation" class="team_filter_li" data-filter=""><a role="menuitem" tabindex="-1"
                                                                                 onclick="removelabel('<?=$label;?>','<?php echo  pll__('No Preference'); ?>','gender-dropdown')"
                                                                                 href="javascript:void(0);"><?php echo pll__('No Preference'); ?></a>
                </li>
                <li role="presentation" class="team_filter_li" data-filter=".Man"><a role="menuitem" tabindex="-1"
                                                                                     onclick="updatelabel('<?=$label;?>','<?php echo pll__('Male'); ?>','gender-dropdown')"
                                                                                     href="javascript:void(0);"><?php echo pll__('Male'); ?></a>
                </li>
                <li role="presentation" class="team_filter_li" data-filter=".Female"><a role="menuitem" tabindex="-1"
                                                                                        onclick="updatelabel('<?=$label;?>','<?php echo pll__('Female'); ?>','gender-dropdown')"
                                                                                        href="javascript:void(0);"><?php echo pll__('Female'); ?></a>
                </li>
