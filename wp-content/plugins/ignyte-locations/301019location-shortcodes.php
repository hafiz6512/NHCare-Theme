...
function ignyte_location_search_form_shortcode($atts)
{
    ...
    <div class="row location-search-controls margin-0">
        ...
        <div class="input-icon"><input disabled='disabled' type="text" placeholder="<?php echo pll__("Zip Code"); ?>"
                                       min="3" maxlength="5"
                                       pattern="[0-9]{10}" class="quicksearch "
                                       value="" id="quicksearch" onkeypress="return isNumberKey(event)"><span
        ...
        <div class="dropdown filters">
            ...
            <ul class="dropdown-menu   button-group" role="menu" aria-labelledby="specialty-dropdown"
                ...
                <li class="team_filter_li" data-filter="">
                    <a role="menuitem" tabindex="-1" onclick="updatelabel('<?php echo pll__("Distance"); ?>',' <?php echo pll__("5 Miles"); ?>','radius-dropdown',5)"
                       href="javascript:void(0);">
                        <?php echo pll__("5 Miles"); ?>
                    </a>
                </li>
                <li role="presentation" class="team_filter_li" data-filter="">
                    <a role="menuitem" tabindex="-1" onclick="updatelabel('<?php echo pll__("Distance"); ?>',' <?php echo pll__("10 Miles"); ?>','radius-dropdown',10)"
                       href="javascript:void(0);">
                        <?php echo pll__("10 Miles"); ?>
                    </a>
                </li>
                <li role="presentation" class="team_filter_li" data-filter="">
                    <a role="menuitem" tabindex="-1" onclick="updatelabel('<?php echo pll__("Distance"); ?>','<?php echo pll__("20 Miles"); ?>','radius-dropdown',20)"
                       href="javascript:void(0);">
                        <?php echo pll__("20 Miles"); ?>
                    </a>
                </li>
                <li role="presentation" class="team_filter_li" data-filter="">
                    <a role="menuitem" tabindex="-1" onclick="updatelabel('<?php echo pll__("Distance"); ?>','<?php echo pll__("50 Miles"); ?>','radius-dropdown',50)"
                       href="javascript:void(0);">
        ...
        <div class="dropdown filters ">
            ...
            <button class="btn dropdown-toggle btn-blue form-control disabled" type="button" id="specialty-dropdown"
    ...
    <script>
        ...
        jQuery(document).ready(function () {
            ...
            setTimeout(function () {
                ...
                jQuery('#specialty-dropdown').removeClass('disabled');
            }, 800);
        });
...
<p>' . $Call . ' <a href="tel:911" class="underline">911</a> ' . $forlife2 . '.</p></div></div>
        ...
        if ($meta_values['ignyte_location_address'][0] != '') {
            $grid .= '<li class="color-shape ' . $listclass . ' ' . $ii . 'result marker' . $ii . '" data_id="marker' . $ii . '" id="marker' . $ii . '"  onclick="showmarker(' . $ii . ')"><span>' . $title . '</span><div style="display: none;"><span class="hiddensearch" ></span>' . $meta_values["ignyte_location_address"][0] . '</div> </li>';
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-offset-1 col-md-10">
                                    ...
                                    <div class="not_found_msg" style="display: none"><h3
                                                class="center green"><?php echo pll__('Sorry, your search returned no results.'); ?></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-offset-1 col-md-11">
                                    <div class="row margin-0">
                                        <div class="pin-desc">
                                            <p class="small"><img
                                                        src="/wp-content/plugins/ignyte-locations/images/marker.svg"/><?php echo pll__("Full Service Location"); ?>
                                            </p>
                                            <p class="small"><img
                                                        src="/wp-content/plugins/ignyte-locations/images/dot.svg"/><?php echo pll__("Specialty Location"); ?>
                                            </p>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        jQuery(document).ready(function () {
            ...
            function filteractive() {
                ...
                jQuery('.filters').on('click', '.team_filter_li ,.viewmodelist ,.hiddendata', function () {
                    var thisdata = jQuery(this);
